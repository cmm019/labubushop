...
// Types
type Phase = 'intro' | 'products' | 'loading1' | 'wheel1' | 'loading2' | 'chest' | 'loading3' | 'challenge' | 'loading4' | 'wheel2' | 'checkout';
...
function App() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-300 via-pink-200 to-blue-200 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="text-center z-10 max-w-sm">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-purple-600 mb-4 animate-text-glow">
          ...
          <div className="mb-6">
            ...
            <div className="bg-white/95 rounded-2xl p-4 mb-6 shadow-lg">
              <p className="text-gray-700 mb-2">
                <span className="text-green-600 font-bold">Parabéns, campeão!</span>
              </p>
  ...
  // Phase 6 - Checkout - ENHANCED WITH PRODUCT SHOWCASE
  const CheckoutPhase = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
      e.preventDefault();
      alert('Pedido enviado! Você receberá um link de pagamento no WhatsApp em instantes!');
    };
      ...
      <div>
        ...
        />
            ...
            >
              ...
              Liberar meu Tesouro por R$ 24,90
            </button>
